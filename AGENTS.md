...
- Truth order: installed `node_modules` types first, then `packages/*/README.md` (plus
  `packages/di/ADVANCED.md`), then `DOCUMENTATION.md`, then `skills/resultar/`, then `docs/rfcs/*`
