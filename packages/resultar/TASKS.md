...
- [x] Decide the `safeTryAsync` policy before the current major line.
  - Removed the deprecated export before the current major line.
- [x] Revisit Node 24-only support.
  - Confirmed Node.js 24+ is intentional for the current major package line.
